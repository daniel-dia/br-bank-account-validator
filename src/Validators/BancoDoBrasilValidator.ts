...
export default class BancoDoBrasilValidator extends CommonBankAccountValidator {
  ...
  public agencyCheckNumberMatch(bankAccount: IBankAccount) {
    const checkNumberCalculated = BancoDoBrasilCheckNumberCalculator.calculateAgency(bankAccount.agencyNumber);
  ...
  public accountCheckNumberMatch(bankAccount: IBankAccount) {
    const checkNumberCalculated = BancoDoBrasilCheckNumberCalculator.calculateAccount(bankAccount.accountNumber);
